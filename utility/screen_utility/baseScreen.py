...
class BaseScreen:
    ...
    def handle_events(self, virtual_mouse):
        for event in pygame.event.get():
            ...
            InspectableFlag.handle_event(event, combined_items, virtual_mouse, self.virtual_size, self.gui_manager, self.item_manager, self.instance_manager.settings, self.instance_manager.sfx_manager)
